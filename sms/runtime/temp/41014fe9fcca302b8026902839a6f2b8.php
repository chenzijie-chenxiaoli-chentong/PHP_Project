<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/123.206.213.22/addons/cms/view/default/list_news.html";i:1598232519;}*/ ?>
<!DOCTYPE html>
<html lang="zh-Hans">
<head>
    <meta charset="utf-8"/>
                ...
                <div id="header" class="okayNav-header header" style="max-height: 70px;">
                    ...
                    <nav role="navigation" id="nav-main" class="okayNav">
                        <ul>
                              ...
                              <?php $__vhGbuLxPlF__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__vhGbuLxPlF__) || $__vhGbuLxPlF__ instanceof \think\Collection || $__vhGbuLxPlF__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__vhGbuLxPlF__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__vhGbuLxPlF__; ?>
                    <!--如果需要无限级请使用cms:nav标签-->
...
<div class="info-top">
    <div class="info-top-h1"><h1> <?php echo $__CHANNEL__['name']; ?>短信验证码在线接收平台</h1></div>
    <div class="info-top-h4"><h4>本页主要提供 <?php echo $__CHANNEL__['name']; ?>临时手机电话号码,使用这些 <?php echo $__CHANNEL__['name']; ?>号码可以用来注册一次性Facebook,Twitter,Instagram,Telegram,Gamil,htomail,netflix...！</h4></div>
</div>
<!--        <div class="search">
            ...
            <div class="breadcrumb">
                <span class="layui-breadcrumb">
                    ...
                    <div class="layui-row layui-col-space15">
                     ...
                     <!-- S 列表 -->
                        <?php $__AmylBjbnSC__ = \addons\cms\model\Archives::getPageList($__PAGELIST__, ["id"=>"item"]); if(is_array($__AmylBjbnSC__) || $__AmylBjbnSC__ instanceof \think\Collection || $__AmylBjbnSC__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__AmylBjbnSC__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
             <div class="layui-col-lg4 layui-col-md4 layui-col-sm6 layui-col-xs12 card">
                    <div class="layui-card" style="height:150px;">
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__AmylBjbnSC__; ?>
                        <!-- E 列表 -->
              ...
              <!--@formatter:off-->
                        <?php if(config('cms.loadmode')=='paging'): ?>
                            ...
                            <?php endif; else: if($__PAGELIST__->isEmpty()): ?>
