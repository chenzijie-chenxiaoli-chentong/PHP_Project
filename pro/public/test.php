...
if ($_REQUEST['action'] == 'refund') {//退款
    $terminal_sn = '100000030007503610';
    $terminal_key = 'f732858ddf10394777aa9db443ce672d';
    refund($terminal_sn, $terminal_key);
}
//{"vendor_sn":"20160317111402","vendor_key":"7a87156a7c8e9ca9cecf2787fefe47d3","appid":"2016081800000003","code":"75290371","terminal_sn":"100000030007503610","terminal_key":"f732858ddf10394777aa9db443ce672d","merchant_sn":"1680002208407","merchant_name":"\u5927\u7406\u51ef\u7a0b\u5546\u52a1\u9152\u5e97","store_sn":"1580000001903383","store_name":"\u5927\u7406\u51ef\u7a0b\u5546\u52a1\u9152\u5e97"}
if ($_REQUEST['action'] == 'activate') {//激活
    $vendor_sn = '20160317111402';//
    $vendor_key = '7a87156a7c8e9ca9cecf2787fefe47d3';//
    activate($vendor_sn, $vendor_key);
}
...
function activate($vendor_sn, $vendor_key)
{
    ...
    $params['app_id'] = '2016081800000003';           //app id，从服务商平台获取2017112500000439
    $params['code'] = '50743196';              //激活码内容11654978
    $params['device_id'] = time();//设备唯一身份ID
...
//        $params['sn']='7895253130995555';              //收钱吧系统内部唯一订单号
    $params['client_sn'] = '123123';//商户系统订单号,必须在商户系统内唯一；且长度不超过64字节
