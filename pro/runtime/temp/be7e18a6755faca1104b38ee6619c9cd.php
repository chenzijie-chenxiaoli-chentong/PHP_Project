<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"X:\PhpstormProjects\PHP_Project\pro\public/../application/admin\view\index\login.html";i:1590577664;}*/ ?>
...
<head>
    ...
    <title><?php echo config('site.name'); ?> - 后台登录</title>
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post" action="<?php echo url('index/login'); ?>">
                    ...
                    <p class="m-t-md"><?php echo config('site.name'); ?> - 后台登录</p>
