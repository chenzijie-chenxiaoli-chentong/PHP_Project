<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/www/wwwroot/47.56.64.247/public/../application/admin/view/payway/create.html";i:1563886832;s:63:"/www/wwwroot/47.56.64.247/application/admin/view/base/head.html";i:1558411548;s:61:"/www/wwwroot/47.56.64.247/application/admin/view/base/js.html";i:1558020051;}*/ ?>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?php echo url('payway/create_deal'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="identify_id" placeholder="标识ID" class="form-control" value="<?php echo input('id') ? $payway_info['identify_id'] : ''; ?>">
                                </div>
                            </div>
