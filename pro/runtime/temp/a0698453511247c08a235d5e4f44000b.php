<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\WWW\wwwroot\pro\public/../application/admin\view\payorder\index.html";i:1588585160;s:56:"D:\WWW\wwwroot\pro\application\admin\view\base\head.html";i:1558411548;s:54:"D:\WWW\wwwroot\pro\application\admin\view\base\js.html";i:1558020051;}*/ ?>
<!DOCTYPE html>
<html>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="orderStatus">
                                            <?php if($data['status'] == '-2' and session('admin.pos') == '9'): ?>

                                                <button class="btn btn-danger btn-xs" onclick="confirm_order('<?php echo $data['order_id']; ?>');"><?php echo $order_status[$data['status']]['name']; ?></button>
                                            ...
                                            <?php else: if($data['status']==''): ?>
                                                ...
                                                <?php else: ?>
                                                    <?php echo $order_status[$data['status']]['name']; endif; endif; ?>
    ...
    function confirm_status(obj , orderid , status){
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                //alert(res.msg);
                if(res.flag=='1000'){
                    var text = (status=='1') ? "<?php echo $order_status[1]['name']; ?>" : "<?php echo $order_status[-2]['name']; ?>";
