<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/www/wwwroot/120.27.60.173/public/../application/admin/view/merchant/index.html";i:1558804843;s:64:"/www/wwwroot/120.27.60.173/application/admin/view/base/head.html";i:1558411548;s:62:"/www/wwwroot/120.27.60.173/application/admin/view/base/js.html";i:1558020051;}*/ ?>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $data['wechat_percent_fee']; ?>%--<?php echo $data['ali_percent_fee']; ?>%</td>
    ...
    <div id="create" style="padding:20px;display:none;">
        ...
        <form class="form-horizontal" id="merchant" method="post" action="<?php echo url('merchant/create'); ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" placeholder="微信费率" class="form-control" name="wechat_percent_fee">
                </div>
                <div class="col-sm-1">
                    %
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" placeholder="支付宝费率" class="form-control" name="ali_percent_fee">
                </div>
                <div class="col-sm-1">
                    %
                </div>
