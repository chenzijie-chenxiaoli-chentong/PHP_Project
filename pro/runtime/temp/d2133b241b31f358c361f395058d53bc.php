<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/www/wwwroot/120.27.60.173/public/../application/admin/view/base/agent.html";i:1559456922;s:64:"/www/wwwroot/120.27.60.173/application/admin/view/base/head.html";i:1558411548;s:62:"/www/wwwroot/120.27.60.173/application/admin/view/base/js.html";i:1558020051;}*/ ?>
<head>
    <meta charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins"><?php echo $my_money/100; ?></h1>
            ...
            <div class="col-sm-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins"><?php echo $my_percent_fee; ?>%</h1>
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins"><?php echo !empty($merchant_today_success['money']/100)?$merchant_today_success['money']/100: 0; ?>(<?php echo round( ($merchant_today_success['money']/$merchant_today_request['money'] ?: 1)*100,2); ?>%)</h1>
                        <div class="stat-percent font-bold text-danger"><i class="fa fa-fire"></i>
                        </div>
                        <small>订单数量：<?php echo $merchant_today_success['num']; ?>(<?php echo round( ($merchant_today_success['num']/$merchant_today_request['num'] ?: 1)*100,2); ?>%)</small>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins"><?php echo $merchant_count; ?></h1>
                        <div class="stat-percent font-bold text-danger"> <i class="fa fa-life-buoy"></i>
                        </div>
                        <small>我的商户总数</small>
                    </div>
                </div>
