<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/www/wwwroot/120.27.60.173/public/../application/admin/view/administrator/create_page.html";i:1558494176;s:64:"/www/wwwroot/120.27.60.173/application/admin/view/base/head.html";i:1558411548;s:62:"/www/wwwroot/120.27.60.173/application/admin/view/base/js.html";i:1558020051;}*/ ?>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?php echo url('administrator/create'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" placeholder="费率" class="form-control" name="percent_fee" value="<?php echo !empty($id)?$info['percent_fee'] : ''; ?>">
                                </div>
                            </div>
