                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <input type="checkbox" class="js-switch" <?php if(input('autorefresh')): ?>checked<?php endif; ?>>
                            </div>
